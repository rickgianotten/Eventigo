                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-3 gap-5">
                                            @foreach ($eventImages as $image)
                                                ...
                                                <input type="radio" id="{{$image['eventType']}}" name="event_image" value="{{$image['eventFilePath']}}" @checked(old('event_image') == $image['eventFilePath'] ) class="hidden peer" :required="false">
